        ...
        <div class="row mb-5">
            ...
            <div class="col-md-6 pr-md-6">
                <div class="ftco-footer-widget mb-6">
                    <h2 class="ftco-heading-2">View Event</h2>

                    <div class="block-21 mb-4 d-flex" onclick="window.location.href='studentEvent?mode=showListEvent'">
                        <a href="#" class="blog-img mr-4" style="background-image: url(images/image_1.jpg);"></a>
                        <div class="text">
                            <h3 class="heading"><a href="#">Autumn Market</a></h3>
                            <div class="meta">
                    ...
                    <div class="block-21 mb-4 d-flex" onclick="window.location.href='studentEvent?mode=showListEvent'">
                        <a href="#" class="blog-img mr-4" style="background-image: url(images/image_2.jpg);"></a>
                        <div class="text">
                            <h3 class="heading"><a href="#">Welcome new students to the school</a></h3>
                            <div class="meta">
                                <div><a href="#"><span class="icon-calendar"></span> Sept 15, 2018</a></div>
                                <div><a href="#"><span class="icon-person"></span> Admin</a></div>
