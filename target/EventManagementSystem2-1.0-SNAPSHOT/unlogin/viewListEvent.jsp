                ...
                <div class="row">
                    ...
                    <div class="col-md-4 ftco-animate ">
                        <div class="blog-entry card">
                            <a href="index?mode=viewEventDetails&id=<%=id%>" class="block-20" style="background-image: url('<%=img%>');" title="click to view more details">
                            </a>
                            <div class="text p-4 d-block">
                                <div class="meta mb-3">
                                    <div><a href="index?mode=viewEventDetails&id=<%=id%>" title="click to view more details"><span class="icon-calendar">&nbsp;</span><%=finalString%></a></div>
                                    <div><a href="index?mode=viewEventDetails&id=<%=id%>" title="click to view more details"><span class="icon-person">&nbsp;</span>Manage By <%=staffName%></a></div> <br>         
                                    <div><a href="index?mode=viewEventDetails&id=<%=id%>" title="click to view more details"><span class="icon icon-phone">&nbsp;</span> <%=staffPhone%></a></div>             
                                </div>
                                <h3 class="heading" ><a href="index?mode=viewEventDetails&id=<%=id%>" title="click to view more details"><%=title%></a></h3>   
                            </div>
                        </div>
                    </div>
                    <%}%>
                    ...
                    <div class="col-12 text-center">
                        <div class="block-27">
                            <ul>
                                ...
                                <li class="active"><a href="index?mode=showListEvent&start=<%=a%>&end=<%=b%>">&ensp;<%=i%>&ensp;</a></li>
